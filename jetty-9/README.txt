...
------------------------------------------------------
Jetty 9.4.12 bundle with pre-installed Oskari
------------------------------------------------------

This package features Jetty 9.4.12 version with pre-installed items:
...
- Geoserver 2.13.2 with WPS-plugin and Oskari extensions (https://github.com/nls-oskari/oskari-server/tree/master/geoserver-ext)
...
- datadir: {JETTY-HOME}/geoserver_data (configurable in {JETTY-HOME}/start.ini). Jetty has been fired up once to populate this directory.
